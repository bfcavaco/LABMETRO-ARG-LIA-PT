...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="mainContent">
    <fieldset>
        ...
        <table>
            ...
            <tr>
                <td colspan="2">
                    Acessórios:<asp:Label ID="lblAcessorios" runat="server"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
                    Múltiplos Serviços:<asp:Label ID="lblMultiplosServicos" runat="server"></asp:Label>
                </td>
            </tr>
        </table>
    ...
    <fieldset>
       ...
       Criterios de Aceitacao (Empresa):<asp:TextBox ID="txtCriteriosAceitacaoEmpresa" runat="server" Width="100%" Height="150" TextMode="MultiLine" ReadOnly="true" ></asp:TextBox>
        <table><tr>
                <td id="tdFicheiroCriterios" runat="server">
                </td></tr></table>
    ...
    <fieldset>
        ...
        <table>
            ...
            <tr>
                ...
                <td><asp:TextBox ID="txtObsEquipamento" runat="server"></asp:TextBox>
                </td>
            </tr>
             <tr>
                <td>
                   Criterios (Equipamento):
                </td>
                <td colspan="3">
                ...
                <td colspan="4">
                    <asp:DataGrid ID="dgHistorico" runat="server" ShowFooter="false" AllowSorting="false"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn HeaderText="<%$ Resources:Resource, Funcionario %>" DataField="userEstado">
                            </asp:BoundColumn>
                           
                            <asp:BoundColumn HeaderText="<%$ Resources:Resource, Comentario %>" DataField="comentario">
                            </asp:BoundColumn>
                        </Columns>
                    </asp:DataGrid>
                </td>
    ...
    <fieldset>
        ...
        <asp:DataGrid ID="dgServicosAnteriores" runat="server" AutoGenerateColumns="false"
            ...
            <Columns>
                <asp:BoundColumn DataField="refServico" HeaderText="<%$ Resources:Resource, RefCalib %>">
                </asp:BoundColumn>
                <asp:BoundColumn DataField="estadoServico" HeaderText="<%$ Resources:Resource, Estado %>">
                </asp:BoundColumn>
                ...
                <asp:BoundColumn DataField="responsavelLaboratorio" HeaderText="<%$ Resources:Resource, AprovadoPor %>">
                </asp:BoundColumn>
            </Columns>
        </asp:DataGrid>
    </fieldset>
    ...
    <br />
    <br />
    <asp:Button class="button" ID="btnRequisicoes" runat="server" CssClass="button" Text="<%$ Resources:Resource, VerOcultarRequisicoes %>">
    </asp:Button>&nbsp;&nbsp;<asp:Button class="button" ID="btnOrcamentos" runat="server"
    ...
    <asp:DataGrid ID="DGRequisicoes" runat="server" ShowFooter="false" AllowSorting="false"
        ...
        <Columns>
            <asp:BoundColumn DataField="refRequisicao" HeaderText="<%$ Resources:Resource, RefReq %>">
            </asp:BoundColumn>
            <asp:BoundColumn DataField="referenciaCliente" HeaderText="<%$ Resources:resource, RefCliente %>">
            </asp:BoundColumn>
    ...
    <div style="float: right; width: 50%">
        <asp:DataGrid ID="dgComentariosOrcamento" runat="server" ShowFooter="true" AllowSorting="False"
            ...
            <Columns>
                <asp:BoundColumn DataField="asterisco" HeaderText="<%$ Resources:Resource, Asterisco %>">
                </asp:BoundColumn>
                <asp:BoundColumn DataField="descricao" HeaderText="<%$ Resources:Resource, Descricao %>">
                </asp:BoundColumn>
            </Columns>
        </asp:DataGrid></div>
</asp:Content>
