    ...
    <fieldset>
        ...
        >
            <Columns>
                ...
                <asp:BoundColumn DataField="LocalEntrada" SortExpression="idLocalEntrada" HeaderText="<%$ Resources:Resource, LocalEntradaEquipamento %>"> </asp:BoundColumn>
                <%--<asp:BoundColumn DataField="LocalDestino" SortExpression="idLocalDestino" HeaderText="<%$ Resources:Resource, LocalDestino %>"> </asp:BoundColumn>--%>
                <asp:BoundColumn DataField="LocalCalibracao" SortExpression="idLocalCalibracao" HeaderText="<%$ Resources:Resource, LocalCalibracao %>"> </asp:BoundColumn>
              

            </Columns>
        </asp:DataGrid>
        <%--* M.S. =<%=Resources.Resource.LegendaMS %>--%> 
