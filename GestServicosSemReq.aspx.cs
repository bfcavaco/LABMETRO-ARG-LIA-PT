...
namespace LabMetro
{
	...
	/// </summary>
	public partial class GestServicosSemReq : System.Web.UI.Page
	{
		...
		private void BindGrid()
		{
			...
			DataSet ds = data.DSServicosSemRequisicao(strNumBRE, strAno, strEmpresa, strRefServico, bFactura,bSemFactura); 
...
//				requisicao = null; 
		...
		private void Button1_Click(object sender, System.EventArgs e)
		{
				...
				DataSet ds = data.DSServicosSemRequisicao(strNumBRE, strAno, strEmpresa, strRefServico, false,true); 
