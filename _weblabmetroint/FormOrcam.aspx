<%@ Page Language="c#" CodeBehind="FormOrcam.aspx.cs" AutoEventWireup="True" Inherits="LabMetro.FormOrcam" MasterPageFile="~/mp.Master" MaintainScrollPositionOnPostback="true" %>
        ...
        <fieldset>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                      ...
                      <asp:RequiredFieldValidator
                            ID="RequiredFieldValDtPedido" runat="server" ControlToValidate="txtDtPedido">*</asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddEstado" runat="server" DataTextField="descricao" DataValueField="ident" OnSelectedIndexChanged="ddEstado_SelectedIndexChanged" AutoPostBack="true">
                        </asp:DropDownList>
                        &nbsp;&nbsp;&nbsp;
                    </td>
                    <td>
        ...
        <fieldset>
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtRefCliente" runat="server" Width="175px" MaxLength="50"></asp:TextBox>
                    </td>
                    <td>
                        <label>
 ...
 ControlToValidate="txtIdPtComercial" ErrorMessage="Inteiro!" />
        ...
        <fieldset>
            ...
            <table>
                <tr>
                    <td colspan="4">
                        <asp:TextBox ID="txtDescontoNovo" runat="server"></asp:TextBox><asp:Button ID="btnActualizarDesconto" runat="server" Text="aplicar desconto nas linhas" OnClick="btnActualizarDesconto_Click"/>
                ...
                <tr>
                    <td align="left" colspan="4">
                        ...
                        <table>
                            ...
                            <tr>
                                <td align="right">
                                    <%=Resources.Resource.ComDesconto %>:<asp:CheckBox ID="chbDesconto" runat="server">
                                    </asp:CheckBox>
                                </td>
                                <td align="right">
