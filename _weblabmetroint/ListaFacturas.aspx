<%@ Page Language="c#" CodeBehind="ListaFacturas.aspx.cs" AutoEventWireup="True"
    Inherits="LabMetro.ListaFacturas" MasterPageFile="~/mp.Master" %>
        ...
        DataKeyField="idFactura">
            <Columns>
                <asp:HyperLinkColumn HeaderText="<%$ Resources:Resource,RefVer %>" DataNavigateUrlFormatString="FormFactura.aspx?btn=FAC&id={0}"
                 ...
                 <asp:HyperLinkColumn HeaderText="ver VD" DataNavigateUrlFormatString="FormVD.aspx?btn=FAC&id={0}"
                    DataNavigateUrlField="idFactura" DataTextField="numVD" SortExpression="numVD"
                    Target="_self">
                    <ItemStyle Font-Bold="True" HorizontalAlign="Left"></ItemStyle>
                </asp:HyperLinkColumn>
                ...
                <asp:BoundColumn DataField="nomeFicheiro" SortExpression="nomeFicheiro" HeaderText="<%$ Resources:Resource, Ficheiro %>">
                </asp:BoundColumn>
                  <asp:BoundColumn DataField="numFacturaSAP" SortExpression="numFacturaSAP" HeaderText="Ref.SAP">
                </asp:BoundColumn>
                <asp:HyperLinkColumn HeaderText="ver VD" DataNavigateUrlFormatString="FormVD.aspx?btn=FAC&id={0}"
                    DataNavigateUrlField="idFactura" DataTextField="numVD" SortExpression="numVD"
                    Target="_self">
