...
namespace LabMetro
{
	...
	public partial class ListaOrcamentos : System.Web.UI.Page
	{
        ...
        private const string ID_PAG = "ORCAMENTOS_0";//NOME DA PAGINA
        ...
        private void BindGrid()
        {
			...
			DataTable dt = orcamento.DTOrcamentos(txtEmpresa.Text, txtTipoEquipamento.Text, ddEstadoOrcamento.SelectedValue, txtRefOrcamento.Text,"",ddFuncionario.SelectedValue); 
