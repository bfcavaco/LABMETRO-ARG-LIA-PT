<%@ Page Language="c#" CodeBehind="GestDocs2.aspx.cs" AutoEventWireup="True" Inherits="LabMetro.GestDocs2"
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="mainContent">
    <fieldset>
        ...
        <br />
        (criar uma checkbox para remover situações antigas, revisoes penduradas etc)
       Só meus: <asp:CheckBox ID="cbShowOnlyCertifsFromLoggedUser" runat="server" AutoPostBack="True" />
        <asp:DataGrid ID="dgCertificados" runat="server" AutoGenerateColumns="False" OnItemDataBound="dgCertificados_ItemDataBound"
            OnSortCommand="SortGrid" AllowSorting="False" OnItemCommand="visualisarCertificado"
            AllowPaging="False" DataKeyField="idServico">
            <Columns>
                <asp:ButtonColumn Text="visualisarDocumento" ButtonType="LinkButton" DataTextField="nomeFicheiroCertificado"
                    Visible="false" SortExpression="nomeFicheiroCertificado" HeaderText="<%$ Resources:Resource, VerDocumento %>"
                    CommandName="Select">
                ...
                <asp:BoundColumn DataField="msgColunaFicheiro" SortExpression="msgColunaFicheiro"
                ...
                <asp:BoundColumn DataField="nomeTecnicoEfectuouServico" SortExpression="nomeTecnicoEfectuouServico"
                    HeaderText="<%$ Resources:Resource, TecnicoCalibValid %>" Visible="True"></asp:BoundColumn>
                <asp:BoundColumn DataField="userNameEfectuouServico" SortExpression="userNameEfectuouServico" HeaderText="<%$ Resources:Resource, UserName %>"
                    Visible="False"></asp:BoundColumn>
                ...
                <asp:TemplateColumn HeaderText="<%$ Resources:Resource, Acreditado %>">
                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                    <ItemTemplate>
                        <asp:CheckBox ID="cbAcreditado" runat="server" AutoPostBack="True" OnCheckedChanged="cbAcreditado_checkedChanged"
                            Checked='<%#DataBinder.Eval(Container, "DataItem.acreditado")%>' Enabled="<%#DataBinder.Eval(Container, "DataItem.podeAlterarTemplate")%>"></asp:CheckBox>
                    </ItemTemplate>
                </asp:TemplateColumn>
                ...
                <asp:BoundColumn DataField="msgColunaFicheiro" ItemStyle-BackColor="Gainsboro">
                </asp:BoundColumn>
                <asp:BoundColumn DataField="nomeFicheiroCertificado" HeaderText="" ItemStyle-BackColor="Gainsboro"
                    Visible="false"></asp:BoundColumn>
