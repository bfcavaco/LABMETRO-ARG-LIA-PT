<%@ Page Language="c#" CodeBehind="GestValidarCertificados.aspx.cs" AutoEventWireup="True"
    Inherits="LabMetro.GestValidarCertificados" EnableEventValidation="false" MasterPageFile="~/mp.Master" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="mainContent">
    <fieldset>
        ...
        <asp:Button class="button" ID="btnDeselectAll" runat="server" CssClass="button" Text="<%$ Resources:Resource, LimparTodos %>" OnClick="btnDeselectAll_Click1">
        </asp:Button>&nbsp;
        ...
        <asp:CheckBox ID="cbTodos" runat="server" Text="<%$ Resources:Resource, VerTodos %>" AutoPostBack="True"
         ...
         <asp:Button class="button_confirm" ID="btnLimparSeleccionados" runat="server" Text="Limpar Rejeitados Marcados" />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        </fieldset>
</asp:Content>
