            ...
            <tr>
                ...
                <td colspan="4">
                    <asp:RadioButtonList ID="rblReports" runat="server" AutoPostBack="True"
                        ...
                        <asp:ListItem Value="rptEquipamentoNaoFacturadoAgrupadoEmpresa" Enabled="false" Text="<%$ Resources:Resource, EquipamentoNaoFacturadoAgrupadoEmpresa %>"></asp:ListItem>
