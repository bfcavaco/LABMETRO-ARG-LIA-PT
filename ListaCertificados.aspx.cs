...
namespace LabMetro
{
    ...
    {
		private const string ID_PAG = "CERTIFICADOS_0";//NOME DA PAGINA
		...
		{
			//certificados começam em 2007....
			

			for (int year = DateTime.Today.Year; year >= 2007; year--)
			{
        ...
        private void BindGrid()
        {
            DATA.EstadoCertificadoBD data = new LabMetro.DATA.EstadoCertificadoBD(); 
			 ...
			 DT = data.DTListCertificado(txtSearchEmpresa.Text,ddGrandeza.SelectedValue,  txtSearchNServico.Text, ddAno.SelectedValue, txtSearchBRE.Text);
		...
		private void btnSearch_Click(object sender, System.EventArgs e)
		{
            ...
            if (ddAno.SelectedIndex < 0 && ddGrandeza.SelectedIndex < 0 && txtSearchBRE.Text == "" && txtSearchEmpresa.Text == "" && txtSearchNServico.Text == "")
            {
                lblMessage.Text = "Inclua um critério de pesquisa";
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
			...
			GERAL.GridViewExportUtil.Export("Certificados.xls", gvCertificados);
		}
    }
}
