<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormVD.aspx.cs" Inherits="LabMetro.FormVD"  MasterPageFile="~/mp.Master" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="mainContent">
    <fieldset>
        <legend>Venda à Dinheiro</legend>
        <fieldset>
        <b>Atenção: só podem criar vendas à dinheiro quem tiver uma sério aberta em SAP!!!
        As vendas à dinheiro têm de ser introduzidas pelo próprio.<br />
        Passos para criar uma VD:<br /> 1. seleccionar a empresa.<br />
        2. Seleccionar os serviços <br />
        3. Editar os serviços, asssociando o preço (que inclui a deslocação). <br />
        4. GRAVAR<br />
        5. Gerar Venda à Dinheiro<br />
        6. Imprimir
        </b>
            <legend><%=Resources.Resource.Empresa %></legend>
            <br />
            <asp:Label ID="lblMessage" runat="server" Font-Size="X-Large" ForeColor="Red"></asp:Label><asp:ValidationSummary ID="valSummary"
                runat="server" HeaderText="Preencha por favor os seguintes campos:" ShowSummary="True"
                 DisplayMode="List" Font-Bold="True"  ></asp:ValidationSummary>
            <table>
            <tr><td colspan="4"><b>NÚMERO VD</b>:<asp:TextBox ID="txtNumVD" Enabled="false" runat="server"></asp:TextBox></td></tr>
           
                <tr>
                    <td>
                        <label>
                            Pesquisar Nome Empresa:</label>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <label>
                            <%=Resources.Resource.Localidade %> <%=Resources.Resource.EmpresaBRE %>:</label>
                    </td>
                    <td>
                    ...
                    <td>
                        <label>
                            <%=Resources.Resource.RegiaoVendas %> <%=Resources.Resource.EmpresaBRE %>:</label>
                    </td>
                    <td>
                        <asp:DropDownList ID="ddRegiaoVendasEmpresa" runat="server">
                        </asp:DropDownList>
                        <br />
                        <asp:Button class="button" ID="btnUpdateRegiaoVendasEmpresa" CssClass="button" runat="server" Text="Actualizar Região" CausesValidation="false"></asp:Button>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        <label>
                           NIF da Empresa/Emp.Contratante:</label>
                    </td>
                    <td>
                        <asp:TextBox ID="txtNif" runat="server"></asp:TextBox>
                        <asp:RequiredFieldValidator
                            ID="Requiredfieldvalidator2" runat="server" ControlToValidate="txtNif" ErrorMessage="Falta NIF">*</asp:RequiredFieldValidator>
                    </td>
                    <td>
                       <asp:Button ID="btnUpdateNif" runat="server" Text="Actualizar NIF" CssClass="button" CausesValidation="false" onclick="btnUpdateNif_Click" />
                    </td>
                    <td>
                    </td>
                </tr>
        ...
        <fieldset>
            <legend><%=Resources.Resource.Requisicoes %></legend>
        ...
        <fieldset>
            <legend><%= Resources.Resource.ServicosAFacturar %></legend>
        ...
        <fieldset>
            <legend><%=Resources.Resource.DadosFactura %></legend>
            <table>
                <tr>
                    <td>
                        <label>
            ...
            <asp:DataGrid ID="dgDestino" runat="server" DataKeyField="idServico" OnSortCommand="SortGridDestino"
                ...
                <Columns>
                    ...
                    <asp:TemplateColumn HeaderText="<%$ Resources:Resource, Valor %>" SortExpression="valor" ItemStyle-HorizontalAlign="Right">
                        <ItemTemplate>
                    ...
                    <asp:TemplateColumn HeaderText="<%$ Resources:Resource, DescontoEmPercentagem %>" SortExpression="percDesconto" ItemStyle-HorizontalAlign="Right">
                        <ItemTemplate>
                    ...
                    <asp:TemplateColumn HeaderText="<%$ Resources:Resource, ValorFinal %>" SortExpression="valorFinal" ItemStyle-HorizontalAlign="Right">
                        <ItemTemplate>
        ...
        <fieldset>
            <legend><%=Resources.Resource.ValoresFactura %></legend>
            <table>
                <tr>
                    <td>
                        <label>
                    ...
                    <td>
                        <asp:TextBox ID="txtValorAjudasCustoDeslocacoes" runat="server" AutoPostBack="true"
                            Width="100px" Enabled="false"></asp:TextBox><asp:CompareValidator ID="Comparevalidator1" runat="server"
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtValorDespesasEnvio" runat="server" AutoPostBack="true" Width="100px" Enabled="false"></asp:TextBox><asp:CompareValidator
                ...
                <tr>
                    ...
                    <td align="center">
                        <asp:Button class="button_confirm" ID="btnSubmit" runat="server" Text="<%$ Resources:Resource, Gravar %>" CausesValidation="true">
                        </asp:Button>
                    </td>
                    <td>
                    </td>
                    ...
                    <br />
          <%--          <asp:RadioButtonList runat="server" ID="rblOperacao">
                    <asp:ListItem value="1" Selected="True">Original</asp:ListItem>
                    <asp:ListItem value="2">Duplicado</asp:ListItem>
                    </asp:RadioButtonList> <br />--%>
                    <asp:RadioButtonList runat="server" ID="rblFormato">
                    <asp:ListItem value="1">A4</asp:ListItem>
                    <asp:ListItem value="2" Selected="True">IM</asp:ListItem>
                    </asp:RadioButtonList>
                    
                        <asp:Button class="button" ID="btnImprimir" CssClass="button" runat="server" Text="Imprimir"
                            Width="150" onclick="btnImprimir_Click" />
                        <br />
                        <br />
                        <asp:Button class="button" ID="btnAnular" CssClass="button" runat="server" Text="Anular"
                            Width="150" onclick="btnAnular_Click" /><br /><br />
                            
                            <asp:Button class="button" ID="btnGerarNovoOriginal" CssClass="button" runat="server" Text="Anular c/ novo Original"
                            Width="150" onclick="btnGerarNovoOriginal_Click" />
                    </td>
                </tr>
            </table>
        </fieldset>
