...
namespace LabMetro
{
    ...
    public partial class GestValidarCertificados2 : System.Web.UI.Page
    {
        ...
        private void InitializeComponent2()
        {
            ...
            this.btnAprovarAll.Click += new System.EventHandler(this.btnAprovarAll_Click);
            this.btnRejeitarAll.Click += new System.EventHandler(this.btnRejeitarAll_Click);
            this.btnDeselectAll.Click += new System.EventHandler(this.btnDeselectAll_Click);
            this.cbTodos.CheckedChanged += new System.EventHandler(this.cbTodos_CheckedChanged);
            this.dgDocumentos.ItemDataBound += new DataGridItemEventHandler(this.dgDocumentos_ItemDataBound);
        }
        #endregion
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (!this.Page.IsPostBack)
                    {
                        if (this.strGrau() == "0")
                        {
                            this.cbTodos.Visible = true;
                        }
                        else
                        {
                            this.cbTodos.Visible = false;
                        }
                        this.ViewState["sortField"] = "idServico"; //importante
                        this.ViewState["sortDirection"] = "DESC";
                        this.ViewState["nomeResponsavel"] = this.strNomeResponsavel();
                        this.BindGridInicial();
                    }
        ...
        private void BindGridInicial()
        {
            ...
            DT = certificadoBD.DTCertificadosPorAprovar(this.txtSearchEmpresa.Text, this.txtSearchNServico.Text, HttpContext.Current.User.Identity.Name.ToString(), admin);
            ...
            foreach (DataRow dr in DT.Rows)
            {
                ...
                if (fileInfosfinais.Length > 0)
                {
                    ...
                    string sigla = this.strExtraiSigla(fileInfosfinais[0].ToString());
            ...
            this.dgDocumentos.DataSource = DT;
            this.dgDocumentos.DataBind();
        ...
        private void BindGrid()
        {
            ...
            this.dgDocumentos.DataSource = DV;
            this.dgDocumentos.DataBind();
        ...
        public void dgDocumentos_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.SelectedItem)
            {
                ...
                this.Response.Write(e.Item.Cells[9].Text.ToString());
        ...
        {
            foreach (DataGridItem dgi in this.dgDocumentos.Items)
            {
        ...
        {
            this.dgDocumentos.CurrentPageIndex = 0;
            this.BindGridInicial();
        }
        ...
        {
            this.txtSearchNServico.Text = "";
            this.txtSearchEmpresa.Text = "";
        }
        ...
        private void SaveCheckBoxValuesToDT()
        {
            ...
            this.ViewState["DT"] = DT; //so preciso guardar dt em viewstate quando faço alterações
        }
        ...
        {
            if (this.VerificaCheckBoxes() == false)
            {
                this.lblMessage.Text = "Verifique as checkboxes, não pode aprovar e rejeitar um certificado ao mesmo tempo.";
                return;
            }
            else
            {
                ...
                if (strIds != "")
                {
                    ...
                    if (idsServicos.Length > 0)
                    {
                        ...
                        //this.updateEstadoCertificados(idsServicos, idsEstadosActuaisCertificado,idsEstadosNovosCertificado, observacoes, idsTipoCertificado,idsServicosPais);

                        this.updateEstadoCertificados(idsServicos, idsEstadosActuaisCertificado, idsEstadosNovosCertificado, obsWorkflow, idsTipoCertificado, idsServicosPais);
                    }


                    this.deleteTempFiles(); //apagar temporarios - penso que este código é obsoleto. dm. out 2007
                    this.BindGridInicial();
                }
        ...
        private bool inserirAssinaturas(string caminhoDocumentoEntrada, string caminhoDocumentoFinal, string userNameTecnico, string nomeDocumento, string nomeTecnico, string tipoServicoEfectuado, string sTipoServico, string sEquipamento, string sRefServicoPai, string idSubtipoServico, string linguaCertificado)
        {
            ...
            //default PT
            string strServico = this.sEfectuado(tipoServicoEfectuado);
            ...
            {
                case "PT":
                    strServico = this.sEfectuado(tipoServicoEfectuado);
                    break;
                case "EN":
                    strServico = this.sEfectuadoEN(tipoServicoEfectuado);
                    strValidado = Resources.Resource.ResponsavelPelaValidacaoEN;
                    break;
                case "FR":
                    strServico = this.sEfectuadoFR(tipoServicoEfectuado);
                    strValidado = Resources.Resource.ResponsavelPelaValidacaoFR;
                    break;
                case "ES":
                    strServico = this.sEfectuadoES(tipoServicoEfectuado);
            ...
            if (this.Session["idPerfil"].ToString() == "4") strTecnico = " (" + Resources.Resource.ResponsavelTecnico + ")";
            ...
            switch (linguaCertificado)
            {
                ...
                case "EN":
                    ...
                    if (this.Session["idPerfil"].ToString() == "4") strTecnico = " (" + Resources.Resource.ResponsavelTecnicoEN + ")";
                    break;
                case "FR":
                    strTecnico = " (" + Resources.Resource.TecnicoFR + ")";
                    if (this.Session["idPerfil"].ToString() == "4") strTecnico = " (" + Resources.Resource.ResponsavelTecnicoFR + ")";
                    break;
                case "ES":
                    strTecnico = " (" + Resources.Resource.TecnicoES + ")";
                    if (this.Session["idPerfil"].ToString() == "4") strTecnico = " (" + Resources.Resource.ResponsavelTecnicoES + ")";
                    break;
            }


            string nomeRespTec = this.ViewState["nomeResponsavel"].ToString() + strTecnico;
            ...
            {
                this.lblMessage.Text += "Falta a assinatura do utilizador " + System.Web.HttpContext.Current.User.Identity.Name.ToString() + ".<br />";
                return false;
            }
            ...
            {
                this.lblMessage.Text += "Falta a assinatura do utilizador " + userNameTecnico + " para validar o certificado " + nomeDocumento + ".<br />";
                return false;
        ...
        private bool assinarEmoverDocumentos(string idServico, string nomeDocumentoIn, string userNameTecLab, string nomeTecLab, string refServico, string sTipoServico, string sEquipamento, string sRefServicoPai, string nomeDocumentoOut, string idSubtipoServico, string refServicoCertificado, string sigla, string linguaCertificado)
        {
            ...
            if (fileInfoConstrucao.Length > 0)
            {
                ...
                try
                {
                    if (inserirAssinaturas(caminhoDocumento, caminhoDocumentoTemp, userNameTecLab, nomeDocumentoIn, nomeTecLab, refServico, sTipoServico, sEquipamento, sRefServicoPai, idSubtipoServico, linguaCertificado) == true)
                    {
                        try
                        {
                            this.assinarCertificadoDigitalmente(caminhoDocumentoTemp, caminhoDocumentoFinal);

                            if (myApp == "ISQ_LABMETRO")
                            {


                                //se a aplicacao for ISQ_LABMETRO tenho de copiar o ficheiro que foi parar à pasta final para a pasta final de espnha
                                //aqui criar uma copia do ficheiro da pasta final para a pasta de espanha caso o refServicoCertificado esteja bempreenchido, fazer validacao

                                FileInfo certificadoEspanha = new FileInfo(caminhoDocumentoFinal);

                                if (refServicoCertificado != "")
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        string nomeFicheiroEspanha = refServicoCertificado.Replace("/", "-") + "-" + sigla + ".pdf";

                                        string caminhoCertificadoEspanha = caminhoPastaCertificadosEspanhois + "\\" + nomeFicheiroEspanha; // + "o refServicoCertificado".
                                        //tenho de ir buscar o nome do certificado de espanha mais a extensao do certificado de portugal

                                        //aqui à volta tenho de pôr uma validacao para ver se o ficheiro existe
                                        certificadoEspanha.CopyTo(caminhoCertificadoEspanha);

                                        //vou fazer ja aqui a seguir o update da bd espanhola

                                        string strSQL = "UPDATE servico set idEstadoCertificado = 4 where refServico = '" + refServicoCertificado + "'";

                                        // actualiza unicamente o estadoCertificado para 4 e nao mexe no estado do Serviço.
                                        // o estado do serviço é actualizado dps quando em Espanha recebem os equipamentos de volta e
                                        // passam de aguarda sub. para sub. calibrada e subcontratacao com certificado.
                                        // dps no listar dos certificados, os serviços que estão em subcont.com ou entregue com 
                                        // aparecem com certificado PORQUE ESTAO NO ESTADOCERTIFICADO QUATRO!!!

                                        //===========================================

                                        GERAL.clsDataAccess.ExecuteNonQueryDB_ESPANHA(strSQL);

                                        //inserir na tabela certificado // so funciona com revisoes, nao funciona com aditamentos pq é demasiado complexo para já

                                        strSQL = "SELECT idServico from Servico where refServico= '" + refServicoCertificado + "'";


                                        object idser = GERAL.clsDataAccess.myExecuteScalarBDEspanha(strSQL);
                                        ...
                                        if (idser != null) //se o idServico is null  O SERVICO ESTÁ NO ESTADO ERRADO
                                        {
                                            ...
                                            //aqui nao ha validacoes se ja existe ou nao existe
                                            switch (sigla)
                                            {
                                                case "1C":
                                                    strSQL = "INSERT INTO certificado (idServico,idTipoCertificado,idFuncionarioEmitiu, dtCertificado,observacoes, dtCriacao, idUtilCriacao, dtAlteracao, idUtilAlteracao ) VALUES (" + idser + ", 1, 0, getdate(),null,getdate(),0,getdate(),0)";
                                                    break;

                                                case "1R":
                                                    strSQL = "INSERT INTO certificado (idServico,idTipoCertificado,idFuncionarioEmitiu, dtCertificado,observacoes, dtCriacao, idUtilCriacao, dtAlteracao, idUtilAlteracao ) VALUES (" + idser + ", 3, 0, getdate(),null,getdate(),0,getdate(),0)";
                                                    break;
                                                case "2R":
                                                    strSQL = "INSERT INTO certificado (idServico,idTipoCertificado,idFuncionarioEmitiu, dtCertificado,observacoes, dtCriacao, idUtilCriacao, dtAlteracao, idUtilAlteracao ) VALUES (" + idser + ", 7, 0, getdate(),null,getdate(),0,getdate(),0)";
                                                    break;
                                                case "3R":
                                                    strSQL = "INSERT INTO certificado (idServico,idTipoCertificado,idFuncionarioEmitiu, dtCertificado,observacoes, dtCriacao, idUtilCriacao, dtAlteracao, idUtilAlteracao ) VALUES (" + idser + ", 8, 0, getdate(),null,getdate(),0,getdate(),0)";

                                                    break;
                                                case "4R":
                                                    strSQL = "INSERT INTO certificado (idServico,idTipoCertificado,idFuncionarioEmitiu, dtCertificado,observacoes, dtCriacao, idUtilCriacao, dtAlteracao, idUtilAlteracao ) VALUES (" + idser + ", 11, 0, getdate(),null,getdate(),0,getdate(),0)";
            ...
            {
                //nao me lembro que problema era esse...
                //quando aprovo certificado primeiro e dps aprovo novamente, 
                //da um erro com os primeiros... os que já foram aprovados. 
                //acho que isso ja foi resolvido
                return false;
            }
        }
        ...
        public void visualisarDocumento(object sender, DataGridCommandEventArgs e)
        {
            if (e.CommandName.ToString() == "Select")
            {
                ...
                ClientScript.RegisterClientScriptBlock(this.GetType(), "mostraCertif", strScript.ToString());
        ...
        private void setupClientScript()
        {
            ...
            //Register the script
            if (!IsClientScriptBlockRegistered("ConfirmarEscolha"))
            {
