<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GestDocsEspana.aspx.cs" Inherits="LabMetro.GestDocsEspana" 
        ...
        <table>
            ...
            <tr>
                <td>
                    ...
                    <asp:Label ID="ficheiro" runat="server"></asp:Label><input id="fileIn" type="file"
