    ...
    <fieldset>
        ...
        OnSelectedIndexChanged="DGTipoEquip_SelectedIndexChanged">
            <Columns>
                ...
                <asp:BoundColumn DataField="idgrandeza" HeaderText="Grandeza" SortExpression="idGrandeza"></asp:BoundColumn>
                ...
                <asp:Boundcolumn DataField="idCRM" HeaderText="idCrm"></asp:Boundcolumn>
                <asp:Boundcolumn DataField="bManter" HeaderText="Mantem-se?"></asp:Boundcolumn>
