...
{
	/// <summary>
	/// Summary description for GestUnidadesAlcance.
	/// </summary>
	public partial class GestUnidadesAlcance : System.Web.UI.Page
	{
        private const string ID_PAG = "UNIDADES_ALCANCE_1";//NOME DA PAGINA
        ...
        private void BindGrid()
        {
            ...
            DataTable DT = tabela.DTTabela("UnidadeAlcance"); 
            ...
            if(e.CommandName == "Insert")
            {
                ...
                if(e.Item.ItemType == ListItemType.Footer)
                {
                    ...
                    else
                    {
                        ...
                        lblMessage.Text = tabela.InsertTable("UnidadeAlcance",txtDescricao.Text,ddEstado.SelectedValue.ToString(), User.Identity.Name.ToString()); 
        ...
        protected void DG_UpdateGrid(Object sender, DataGridCommandEventArgs e)
        {
            ...
            else
            {
                ...
                lblMessage.Text = tabela.UpdateTable("UnidadeAlcance",id,txtDescricao.Text,ddEstado.SelectedValue.ToString(), User.Identity.Name.ToString()); 
